...
import classesPlay from  "../components/TrackCard/TrackCard.module.scss";
      ...
      <g fill="none">
        <g transform="translate(2.000000, 2.000000)" strokeWidth="4">
          <path
            ...
            className={`${classes["lineOne"]} ${classesPlay['lineOne']}`}
            stroke="#000000"
          ></path>
          <path
          ...
          <path
            ...
            className={`${classes["lineTwo"]} ${classesPlay['lineTwo']}`}
            stroke="#000000"
          ></path>
        </g>
      </g>
