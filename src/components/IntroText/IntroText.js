...
function IntroText() {
    ...
    return ( <section className={classes["text"]}>
       <p>
        ...
        Praesentium distinctio vel ut veniam earum quisquam at error alias perferendis ad placeat dolore, magnam accusantium animi, numquam natus. Facilis explicabo sequi neque ab vel optio esse corrupti? Id, reiciendis!
       </p>
